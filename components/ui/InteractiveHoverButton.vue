<template>
  ...
  >
    ...
    <div
      class="absolute left-[18%] top-[40%] size-2 scale-100 rounded-lg bg-white transition-all duration-300 group-hover:left-0 group-hover:top-0 group-hover:size-full group-hover:scale-[1.8] group-hover:bg-white"
    ></div>
  </button>
</template>
