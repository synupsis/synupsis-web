        ...
        <div
            ...
            <div class="mb-6">
                ...
                <label class="relative block">
                    ...
                    <input
                        ...
                        placeholder="Enter your username" type="text" style="color:black" name="usernameinput" />
                </label>
            </div>
            ...
            <div class="mb-2">
                ...
                <label class="relative block">
                    ...
                    <input
                        class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-xs"
                        placeholder="Enter your email here" type="email" style="color:black" name="emailinput" />
                </label>
            </div>
            ...
            <div class="mb-6">
                ...
                <label class="relative block">
                    ...
                    <input
                        class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-xs"
                        placeholder="Confirm your email" type="email" style="color:black" name="emailconfirmationinput" />
                </label>
            </div>
            ...
            <div class="mb-2">
                ...
                <label class="relative block">
                    ...
                    <input
                        class="placeholder:italic placeholder:text-slate-400 block bg-white w-full border border-slate-300 rounded-md py-2 pr-3 shadow-sm focus:outline-none focus:border-sky-500 focus:ring-sky-500 focus:ring-1 sm:text-xs"
                        placeholder="Enter your password here" type="password" style="color:black" name="pwdinput" />
                </label>
            </div>
            ...
            <div class="mb-2">
                ...
                <label class="relative block">
                    ...
                    <input
                        ...
                        placeholder="Confirm your password" type="password" style="color:black" name="confirmpwdinput" />
                </label>
            </div>
            ...
            <div class="flex justify-center mb-1">
                <button class="w-40 h-10 rounded-lg text-white bg-purple-950 hover:bg-purple-500 transition">Register</button>
            </div>

            <div class="flex justify-center gap-1">
                <p class="text-black text-sm">Already registered ?</p>
                <div class="text-black text-sm underline underline-offset-1">
                    <a href="http://localhost:3000/login">Login</a> <!-- remplacer par le lien définitif-->
                </div>
            </div>
