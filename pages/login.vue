<template>
  <div
    class='text-black bg-blue-900 relative flex min-h-screen flex-col justify-center overflow-hidden py-6 sm:py-12'
  >
    <div
    ...
    >
      ...
      <div class='flex justify-center gap-1'>
        ...
        <div class='text-black text-sm underline underline-offset-1'>
          <Button to='/signup' type='link'>Register</Button>
        </div>
      </div>
    </div>
  </div>
